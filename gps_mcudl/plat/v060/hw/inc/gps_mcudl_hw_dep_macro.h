...
#define CONN_INFRA_REMAPPING_OFFSET 0
#include "gps_dl_hw_ver.h"
#include "mcudl/conn_infra/conn_cfg.h"
#include "mcudl/conn_infra/conn_cfg_on.h"
#include "mcudl/conn_infra/conn_host_csr_top.h"
#include "mcudl/conn_infra/conn_wt_slp_ctl_reg.h"
#include "mcudl/conn_infra/conn_bus_cr.h"
#include "mcudl/conn_infra/conn_rgu_on.h"
#include "mcudl/conn_infra/conn_semaphore.h"
#include "mcudl/conn_infra/conn_dbg_ctl.h"
#include "mcudl/conn_infra/ap2bgf_conn_infra_on_ccif4.h"
#include "mcudl/conn_infra/bgf2ap_conn_infra_on_ccif4.h"

#include "mcudl/mcu_top/bg_gps_rgu_on.h"
#include "mcudl/mcu_top/bg_gps_cfg.h"
#include "mcudl/mcu_top/bg_gps_cfg_on.h"

#include "mcudl/mcu_top/bg_gps_mcu_confg.h"
#include "mcudl/mcu_top/bg_gps_mcu_bus_cr.h"
...
#define GDL_HW_SUPPORT_LIST "SUPPORT:MT6895,MT6989"
...
#define GDL_HW_SET_CONN2GPS_SLP_PROT_RX_DIS_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
...
#define GDL_HW_SET_GPS2CONN_SLP_PROT_TX_DIS_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
...
#define GDL_HW_SET_GPS2CONN_AXI_SLP_PROT_RX_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_EN, val)

#define CONN_INFRA_AXI_GPS2CONN_SLP_BIT22_STATUS_ADDR 0x18001490
#define CONN_INFRA_AXI_GPS2CONN_SLP_BIT22_STATUS_MASK (1UL << 22)
#define CONN_INFRA_AXI_GPS2CONN_SLP_BIT22_STATUS_SHFT 22
#define GDL_HW_POLL_GPS2CONN_AXI_SLP_PROT_RX_UNTIL_VAL(val, timeout, p_is_okay) \
	GDL_HW_POLL_CONN_INFRA_ENTRY( \
		CONN_INFRA_AXI_GPS2CONN_SLP_BIT22_STATUS, \
		val, timeout, p_is_okay)


#define GDL_HW_SET_GPS2CONN_AXI_SLP_PROT_TX_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_EN, val)

#define GDL_HW_SET_GPS2CONN_AXI_SLP_PROT_TX_DIS_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_SLP_CTRL_CFG_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_DIS, val)

#define CONN_INFRA_AXI_GPS2CONN_SLP_BIT23_STATUS_ADDR 0x18001490
#define CONN_INFRA_AXI_GPS2CONN_SLP_BIT23_STATUS_MASK (1UL << 23)
#define CONN_INFRA_AXI_GPS2CONN_SLP_BIT23_STATUS_SHFT 23
#define GDL_HW_POLL_GPS2CONN_AXI_SLP_PROT_TX_UNTIL_VAL(val, timeout, p_is_okay) \
	GDL_HW_POLL_CONN_INFRA_ENTRY( \
		CONN_INFRA_AXI_GPS2CONN_SLP_BIT23_STATUS, \
		val, timeout, p_is_okay)


/* For MT6890, no need to wait */
...
/* For MT6980, the address for GPS is 0x18000028 */
...
#define GDL_HW_FORCE_OSC_CTL(val) do { \
	unsigned int tmp_val; \
	tmp_val = GDL_HW_RD_GPS_REG(BG_GPS_CFG_ON_GPS_OSC_CTL_MANUAL_ADDR); \
	if (val == 0) \
		tmp_val = \
			(0xaa000000 | (tmp_val & 0xFFFF)) & \
			~BG_GPS_CFG_ON_GPS_OSC_CTL_MANUAL_GPS_OSC_ST0_TO_WAIT1_MANUAL_MASK; \
	else \
		tmp_val = \
			(0xaa000000 | (tmp_val & 0xFFFF)) | \
			BG_GPS_CFG_ON_GPS_OSC_CTL_MANUAL_GPS_OSC_ST0_TO_WAIT1_MANUAL_MASK; \
	GDL_HW_WR_GPS_REG(BG_GPS_CFG_ON_GPS_OSC_CTL_MANUAL_ADDR, tmp_val); \
	GDL_HW_RD_GPS_REG(BG_GPS_CFG_ON_GPS_OSC_CTL_MANUAL_ADDR); \
} while (0)
...
#define VDNR_DEBUG_AO_CTRL_ADDR 0x18c1f000
#define VDNR_DEBUG_CTRL_RESULT_ADDR 0x18c1f408
