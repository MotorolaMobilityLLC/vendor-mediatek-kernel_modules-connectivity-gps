...
#define GDL_HW_CHECK_CONN_INFRA_VER(p_poll_okay, p_poll_ver)             \
	GDL_HW_POLL_ENTRY_VERBOSE(GPS_DL_CONN_INFRA_BUS,                 \
		...
		p_poll_okay, p_poll_ver, POLL_DEFAULT, (                 \
			(*p_poll_ver == GDL_HW_CONN_INFRA_VER_MT6991))   \
	)
...
#define GDL_HW_CHECK_BGF_IP_VER(p_poll_okay, p_poll_ver)             \
	GDL_HW_POLL_ENTRY_VERBOSE(GPS_DL_GPS_BUS,                 \
		...
		p_poll_okay, p_poll_ver, POLL_DEFAULT, (                 \
			(*p_poll_ver == GDL_HW_BGF_VER_MT6991))   \
	)
...
#define GDL_HW_SET_PERI_REMAP_FIELD \
	CONN_BUS_CR_CONN2AP_REMAP_GPS_PERI_BASE_ADDR_CONN2AP_REMAP_GPS_PERI_BASE_ADDR

#define GDL_HW_SET_CONN2GPS_SLP_PROT_RX_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_CONN2GPS_SLP_CTRL_CFG_CONN2GPS_GALS_RX_SLP_PROT_SW_EN, val)

#define GDL_HW_GET_CONN2GPS_SLP_PROT_RX_VAL() \
	GDL_HW_GET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_CONN2GPS_SLP_CTRL_CFG_CONN2GPS_GALS_RX_SLP_PROT_SW_EN)

#define GDL_HW_SET_CONN2GPS_SLP_PROT_DIS_RX_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_CONN2GPS_SLP_CTRL_CFG_CONN2GPS_GALS_RX_SLP_PROT_SW_DIS, val)

#define GDL_HW_POLL_CONN2GPS_SLP_PROT_RX_UNTIL_VAL(val, timeout, p_is_okay) \
	GDL_HW_POLL_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_GALS_CONN2GPS_SLP_STATUS_CONN2GPS_GALS_CTRL_PROT_RX_RDY, \
...
#define GDL_HW_SET_CONN2GPS_SLP_PROT_TX_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_CONN2GPS_SLP_CTRL_CFG_CONN2GPS_GALS_TX_SLP_PROT_SW_EN, val)

#define GDL_HW_GET_CONN2GPS_SLP_PROT_TX_VAL() \
	GDL_HW_GET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_CONN2GPS_SLP_CTRL_CFG_CONN2GPS_GALS_TX_SLP_PROT_SW_EN)

#define GDL_HW_POLL_CONN2GPS_SLP_PROT_TX_UNTIL_VAL(val, timeout, p_is_okay) \
	GDL_HW_POLL_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_GALS_CONN2GPS_SLP_STATUS_CONN2GPS_GALS_CTRL_PROT_TX_RDY, \
		val, timeout, p_is_okay)
...
#define GDL_HW_SET_GPS2CONN_SLP_PROT_RX_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_GPS2CONN_SLP_CTRL_CFG_GPS2CONN_GALS_RX_SLP_PROT_SW_EN, val)

#define GDL_HW_GET_GPS2CONN_SLP_PROT_RX_VAL() \
	GDL_HW_GET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_GPS2CONN_SLP_CTRL_CFG_GPS2CONN_GALS_RX_SLP_PROT_SW_EN)

#define GDL_HW_POLL_GPS2CONN_SLP_PROT_RX_UNTIL_VAL(val, timeout, p_is_okay) \
	GDL_HW_POLL_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_GALS_GPS2CONN_SLP_STATUS_GPS2CONN_GALS_CTRL_PROT_RX_RDY, \
		val, timeout, p_is_okay)
...
#define GDL_HW_SET_GPS2CONN_SLP_PROT_TX_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_GPS2CONN_SLP_CTRL_CFG_GPS2CONN_GALS_TX_SLP_PROT_SW_EN, val)

#define GDL_HW_GET_GPS2CONN_SLP_PROT_TX_VAL() \
	GDL_HW_GET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_GPS2CONN_SLP_CTRL_CFG_GPS2CONN_GALS_TX_SLP_PROT_SW_EN)

#define GDL_HW_SET_GPS2CONN_SLP_PROT_DIS_TX_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_GPS2CONN_SLP_CTRL_CFG_GPS2CONN_GALS_TX_SLP_PROT_SW_DIS, val)

#define GDL_HW_POLL_GPS2CONN_SLP_PROT_TX_UNTIL_VAL(val, timeout, p_is_okay) \
	GDL_HW_POLL_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_GALS_GPS2CONN_SLP_STATUS_GPS2CONN_GALS_CTRL_PROT_TX_RDY, \
		val, timeout, p_is_okay)
...
#define GDL_HW_SET_GPS2CONN_AXi_SLP_PROT_RX_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_GALS_RX_SLP_PROT_SW_EN, \
		val)

#define GDL_HW_POLL_GPS2CONN_AXi_SLP_PROT_RX_UNTIL_VAL(val, timeout, p_is_okay) \
	GDL_HW_POLL_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_RX_RDY, \
		val, timeout, p_is_okay)

#define GDL_HW_SET_GPS2CONN_AXi_SLP_PROT_TX_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_EN, \
		val)

#define GDL_HW_SET_GPS2CONN_AXi_SLP_PROT_DIS_TX_VAL(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_CONN_INFRA_AXI_LAYER_GPS2CONN_GALS_TX_SLP_PROT_SW_DIS, \
		val)

#define GDL_HW_POLL_GPS2CONN_AXi_SLP_PROT_TX_UNTIL_VAL(val, timeout, p_is_okay) \
	GDL_HW_POLL_CONN_INFRA_ENTRY( \
		CONN_CFG_ON_GALS_AXI_LAYER_GPS2CONN_GALS_CTRL_PROT_TX_RDY, \
		val, timeout, p_is_okay)

/* For MT6980, related register of SPI*/
#define GDL_HW_WR_CONN_RF_SPI_MST_SPI_FM_ADDR(val) \
	GDL_HW_WR_CONN_INFRA_REG(CONN_RF_SPI_MST_REG_SPI_FM_ADDR_ADDR, val)

#define GDL_HW_WR_CONN_RF_SPI_MST_SPI_FM_WDAT(val) \
	GDL_HW_WR_CONN_INFRA_REG(CONN_RF_SPI_MST_REG_SPI_FM_WDAT_ADDR, val)

#define GDL_HW_RD_CONN_RF_SPI_MST_SPI_FM_RDAT() \
	GDL_HW_RD_CONN_INFRA_REG(CONN_RF_SPI_MST_REG_SPI_FM_RDAT_ADDR)

/* For MT6980, DMA related CR*/
#define GDL_HW_GET_GPS_DMA_START_STR_STATUS(val) \
	GDL_HW_EXTRACT_ENTRY(CONN_MCU_DMA_DMA7_START_STR, val)

#define GDL_HW_GET_GPS_DMA_INTSTA_STATUS(val) \
	GDL_HW_EXTRACT_ENTRY(CONN_MCU_DMA_DMA7_INTSTA_INT, val)

#define GDL_HW_MAY_GET_DMA_STATE_STATUS(val)  true

/* For MT6980, gps common on */
#define GDL_HW_SET_GPS_EMI_REQ(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY(CONN_CFG_EMI_CTL_GPS_EMI_REQ_GPS, val)

/* For MT6899, no need to wait */
#define GDL_HW_MAY_WAIT_CONN_INFRA_SLP_PROT_DISABLE_ACK(p_poll_okay) { \
	*p_poll_okay = true; \
}

/* For MT6899, the dump address list as below */
...
#define GDL_HW_SET_CONN_INFRA_BGF_EN(val) do { \
	...
	tmp_val = GDL_HW_RD_CONN_INFRA_REG(CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_1_ADDR); \
	if (val == 0) \
		tmp_val = (0x42540000 | (tmp_val & 0xFFFF)) & ~0x80; \
	else \
		tmp_val = (0x42540000 | (tmp_val & 0xFFFF)) | 0x80; \
	GDL_HW_WR_CONN_INFRA_REG(CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_1_ADDR, tmp_val); \
	GDL_HW_RD_CONN_INFRA_REG(CONN_RGU_ON_BGFYS_ON_TOP_PWR_CTL_1_ADDR); \
} while (0)

/* For Bollinger, set mcu sleep ctrl disable */
#define GDL_HW_SET_GPS_MCU_SLEEP_CTRL_DISABLE(val) do { \
		unsigned int tmp_val; \
		tmp_val = GDL_HW_RD_GPS_REG( \
			BG_GPS_CFG_ON_GPS_BUS_SLP_PROT_CTL2_BG_SW_GPS2MCU_SLP_PROT_REQ_EN_ADDR); \
		if (val == 0) \
			tmp_val = tmp_val & 0xFFFFFFFE; \
		else \
...
#define GDL_HW_SET_GPS_FUNC_EN(val) \
	GDL_HW_SET_CONN_INFRA_ENTRY(CONN_CFG_ON_CONN_INFRA_CFG_GPS_PWRCTRL0_GPS_FUNCTION_EN, val)

/* For MT6899, GPS has dedicate entry for top clk control
...
#define GDL_HW_ADIE_TOP_CLK_EN(val, p_poll_okay) do { \
	...
	GDL_HW_POLL_CONN_INFRA_ENTRY( \
		CONN_WT_SLP_CTL_REG_WB_SLP_TOP_CK_5_WB_SLP_TOP_CK_5_BSY, 0, POLL_DEFAULT, \
		p_poll_okay); \
	if (val) { \
		GDL_HW_SET_CONN_INFRA_ENTRY( \
...
#define GDL_HW_RD_SPI_GPS_STATUS() do { \
	...
	GDL_HW_RD_CONN_INFRA_REG(CONN_RF_SPI_MST_REG_SPI_GPS_ADDR_ADDR); \
	GDL_HW_RD_CONN_INFRA_REG(CONN_RF_SPI_MST_REG_SPI_GPS_WDAT_ADDR); \
	GDL_HW_RD_CONN_INFRA_REG(CONN_RF_SPI_MST_REG_SPI_GPS_RDAT_ADDR); \
	GDL_HW_RD_CONN_INFRA_REG(CONN_RF_SPI_MST_REG_SPI_STA_ADDR); \
} while (0)

#define GPS_CFG_ON_GPS_CLKGEN1_CTL_CR_GPS_DIGCK_DIV_EN \
	BG_GPS_CFG_GPS_CLKGEN_CTL1_CR_GPS_DIGCK_DIV_EN
...
#define COS_SEMA_COEX_STA_ENTRY_FOR_GPS BG_GPS_CFG_GPS_CLKGEN_CTL1_CR_GPS_DIGCK_DIV_EN

#define COS_SEMA_COEX_REL_ENTRY_FOR_GPS BG_GPS_CFG_GPS_CLKGEN_CTL1_CR_GPS_DIGCK_DIV_EN
#endif
