...
void gps_dl_hw_dep_cfg_dsp_mem(enum dsp_ctrl_enum ctrl)
{
	...
	case GPS_L1_DSP_ENTER_DSLEEP:
		...
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_SLP_RGU_GPS_L1_N1_MEM_SWCTL_SLP, 0x1FFF);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_PDN_RGU_GPS_L1_N1_MEM_SWCTL_PDN, 0x0);
		break;
	...
	case GPS_L1_DSP_OFF:
		...
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPYRAM_SLP_EN_RGU_GPS_L1_YRAM_HWCTL_SLP, 0);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_SLP_RGU_GPS_L1_N1_MEM_SWCTL_SLP, 0x0);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_PDN_RGU_GPS_L1_N1_MEM_SWCTL_PDN, 0x1FFF);
		break;
