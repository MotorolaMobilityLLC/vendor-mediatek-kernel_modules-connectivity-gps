...
void gps_dl_hw_dep_cfg_dsp_mem_6991(enum dsp_ctrl_enum ctrl)
{
	switch (ctrl) {
	case GPS_L1_DSP_ENTER_DSLEEP:
		...
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPPRAM_SLP_EN_RGU_GPS_L1_PRAM_HWCTL_SLP, 0x7F);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPXRAM_PDN_EN_RGU_GPS_L1_XRAM_HWCTL_PDN, 0);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPXRAM_SLP_EN_RGU_GPS_L1_XRAM_HWCTL_SLP, 0x3);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPYRAM_PDN_EN_RGU_GPS_L1_YRAM_HWCTL_PDN, 0);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPYRAM_SLP_EN_RGU_GPS_L1_YRAM_HWCTL_SLP, 0x7FFFFF);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_SLP_EN_RGU_GPS_L1_N1_MEM_HWCTL_SLP, 0x1FFF);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_PDN_EN_RGU_GPS_L1_N1_MEM_HWCTL_PDN, 0x0);
		break;
	case GPS_L1_DSP_ENTER_DSTOP:
		...
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPXRAM_SLP_EN_RGU_GPS_L1_XRAM_HWCTL_SLP, 0x3);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPYRAM_PDN_EN_RGU_GPS_L1_YRAM_HWCTL_PDN, 0x7FFFFF);
		GDL_HW_SET_GPS_ENTRY(
	...
	case GPS_L1_DSP_OFF:
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPPRAM_PDN_EN_RGU_GPS_L1_PRAM_HWCTL_PDN, 0x7F);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPPRAM_SLP_EN_RGU_GPS_L1_PRAM_HWCTL_SLP, 0);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPXRAM_PDN_EN_RGU_GPS_L1_XRAM_HWCTL_PDN, 0x3);
		GDL_HW_SET_GPS_ENTRY(
		...
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPYRAM_SLP_EN_RGU_GPS_L1_YRAM_HWCTL_SLP, 0);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_SLP_EN_RGU_GPS_L1_N1_MEM_HWCTL_SLP, 0x0);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_PDN_EN_RGU_GPS_L1_N1_MEM_HWCTL_PDN, 0x1FFF);
		break;
...
void gps_dl_hw_dep_cfg_dsp_mem_6993(enum dsp_ctrl_enum ctrl)
{
	switch (ctrl) {
	case GPS_L1_DSP_ENTER_DSLEEP:
		GDL_HW_SET_GPS_ENTRY(
		...
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_DSPYRAM_SLP_EN_RGU_GPS_L1_YRAM_HWCTL_SLP, 0x7FFFFF);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_SLP_EN_RGU_GPS_L1_N1_MEM_HWCTL_SLP, 0x3FFFFFF);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_PDN_EN_RGU_GPS_L1_N1_MEM_HWCTL_PDN, 0x0);
		break;
	case GPS_L1_DSP_ENTER_DSTOP:
	...
	case GPS_L1_DSP_OFF:
		...
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_SLP_EN_RGU_GPS_L1_N1_MEM_HWCTL_SLP, 0x0);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L1_N1_MEM_PDN_EN_RGU_GPS_L1_N1_MEM_HWCTL_PDN, 0x3FFFFFF);
		break;
...
void gps_dl_hw_dep_cfg_dsp_mem(enum dsp_ctrl_enum ctrl)
{
	...
	case GPS_L1_DSP_OFF:
		...
		if (GDL_HW_CONN_INFRA_VER_MT6991 == conn_ver)
			gps_dl_hw_dep_cfg_dsp_mem_6991(ctrl);
		else if (GDL_HW_CONN_INFRA_VER_MT6993 == conn_ver)
			gps_dl_hw_dep_cfg_dsp_mem_6993(ctrl);
		else
			GDL_LOGW("unknown conn ver 0x%08x, do not cfg dsp mem", conn_ver);
	...
	case GPS_L5_DSP_ENTER_DSLEEP:
		...
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L5_DSPPRAM_SLP_EN_RGU_GPS_L5_PRAM_HWCTL_SLP, 0x3F);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L5_DSPXRAM_PDN_EN_RGU_GPS_L5_XRAM_HWCTL_PDN, 0);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L5_DSPXRAM_SLP_EN_RGU_GPS_L5_XRAM_HWCTL_SLP, 0x3);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L5_DSPYRAM_PDN_EN_RGU_GPS_L5_YRAM_HWCTL_PDN, 0);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L5_DSPYRAM_SLP_EN_RGU_GPS_L5_YRAM_HWCTL_SLP, 0xFFF);
		break;
	case GPS_L5_DSP_ENTER_DSTOP:
		...
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L5_DSPXRAM_SLP_EN_RGU_GPS_L5_XRAM_HWCTL_SLP, 0x3);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L5_DSPYRAM_PDN_EN_RGU_GPS_L5_YRAM_HWCTL_PDN, 0xFFF);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L5_DSPYRAM_SLP_EN_RGU_GPS_L5_YRAM_HWCTL_SLP, 0);
		break;
	case GPS_L5_DSP_OFF:
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L5_DSPPRAM_PDN_EN_RGU_GPS_L5_PRAM_HWCTL_PDN, 0x3F);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L5_DSPPRAM_SLP_EN_RGU_GPS_L5_PRAM_HWCTL_SLP, 0);
		GDL_HW_SET_GPS_ENTRY(
			BG_GPS_RGU_ON_GPS_L5_DSPXRAM_PDN_EN_RGU_GPS_L5_XRAM_HWCTL_PDN, 0x3);
		GDL_HW_SET_GPS_ENTRY(
