...
bool gps_dl_hw_dep_gps_control_adie_on_6993(void)
{
	...
	GDL_HW_SET_AP_ENTRY(0x13820018, 0, 0xffffffff, 0x00000e00);
	GDL_HW_SET_AP_ENTRY_TO_CHECK(0x13820010, 0, 0x00000e00, 0x0);
	GDL_HW_SET_AP_ENTRY(0x13820014, 0, 0xffffffff, 0x00000e00);
	GDL_HW_SET_AP_ENTRY_TO_CHECK(0x13820010, 0, 0x00000e00, 0x00000e00);
	...
	GDL_HW_SET_AP_ENTRY(0x1002d6a8, 0, 0xffffffff, 0x00000100);
	GDL_HW_SET_AP_ENTRY_TO_CHECK(0x1002d6a0, 0, 0x00000100, 0x0);
